...
def _ensure_task_deliverable_in_client_drive(t, cid, drive_link, filename=None):
    ...
    def _worker():
        try:
            ...
            emp_name = str(t.get("assignee_name") or "")
            plan_name = str(t.get("plan_name") or t.get("file_name") or _client_name(cid) or "خطة").strip()
            sec_eid = str(t.get("secondary_employee_id") or "")
            sec_name = str(t.get("secondary_assignee_name") or "")
