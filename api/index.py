...
def _all_tasks_db():
    """ALL tasks across every client — Google Sheets (authoritative, 100% persistent)
    merged with in-memory cache and Supabase."""
    tasks_map = {}
    
    # 1. Authoritative: Read from Google Sheets Tasks tab
    try:
    ...
    # 2. Supabase mam_tasks (if available)
    try:
