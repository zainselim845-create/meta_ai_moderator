...
def api_employees_workload():
    ...
    # Build name-to-eid map from roster
    name_to_eid = {}
    try:
        cfg = hr_config()
        for e in _gsheet_rows(cfg["sheet_id"], cfg["employees_gid"]):
