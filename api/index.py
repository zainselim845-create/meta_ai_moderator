...
def _gsheet_tasks_save_all(tasks_list):
    ...
    try:
        ...
        try:
            clear_url = f"https://sheets.googleapis.com/v4/spreadsheets/{sheet_id}/values/Tasks!A2:O5000:clear"
