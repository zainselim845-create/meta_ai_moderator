            ...
            if my_cids:
                raw_tasks = [
                    ...
                    if (t.get("client_id") in my_cids) or
                       ...
                       (my_name and str(t.get("am_name") or "").strip().lower() == my_name)
                ]
            else:
                raw_tasks = all_db
