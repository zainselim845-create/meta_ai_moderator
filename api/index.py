...
def api_task_upload_complete(task_id):
    ...
    if token:
        ...
        for ef in [emp_fid, sec_fid]:
            if ef and ef != client_fid:
                try:
                    sc_meta = {
                        "name": (request.get_json() or {}).get("filename", f"asset-{fid}"),
                        "mimeType": "application/vnd.google-apps.shortcut",
                        "parents": [ef],
                        "shortcutDetails": {"targetId": fid}
                    }
