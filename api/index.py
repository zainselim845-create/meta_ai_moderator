...
def api_task_upload_asset(task_id):
    ...
    # Store in BOTH Employee's dedicated Plan Folder AND Client's Monthly Folder
    ...
    target_pids = [p for p in [emp_fid, client_fid] if p]
    if not target_pids:
